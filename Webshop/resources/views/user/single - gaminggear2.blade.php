...
<div id="picture-frame">
			<img src="images/ki4.jpg" data-src="images/ki4.jpg" alt="" class="img-responsive"/>
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3>LG 34UC99-W 34" IPS 2K FreeSync</h3>
				
					
				 <div class="pr-single">
				  <p class="reduced "><del>19,490,000</del>16,490,000 VND</p>
				</div>
				<div class="block block-w3">
					<div class="starbox small ghosting"> </div>
				</div>
				<p class="in-pa">
					A high-performance gaming and productivity monitor with a 34" IPS panel, 2560x1440 resolution, 120Hz refresh rate, and AMD FreeSync support.
				</p>
				<ul>
				  <li>Panel: 34" IPS</li>
				  ...
				  <li>Features: 21:9 aspect ratio, HDR 10 support, USB-C connectivity</li>
				</ul>
				<p>
				  The LG 34UC99-W is a great choice for gamers and productivity users who want a large, high-resolution display with a fast refresh rate. The IPS panel provides excellent image quality, while the FreeSync support eliminates screen tearing and stuttering.
				</p>
				<p>
				  The monitor also features a number of gaming- and productivity-centric features, such as a 21:9 aspect ratio, HDR 10 support, and USB-C connectivity.
				</p>
				<p>
				  Here are some additional details about the LG 34UC99-W monitor:
				  * The IPS panel provides excellent image quality, with wide viewing angles and accurate colors.
				  * The FreeSync support eliminates screen tearing and stuttering, providing smooth gameplay.
				  * The monitor features a number of gaming- and productivity-centric features, such as a 21:9 aspect ratio, HDR 10 support, and USB-C connectivity.
				</p>
				...
				<ul class="social-top">
					...
					<div class="add add-3">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="LG 34UC99-W 34" data-summary="summary 1" data-price="16490000" data-quantity="1" data-image="images/ki4.jpg">Add to Cart</button>
										</div>
