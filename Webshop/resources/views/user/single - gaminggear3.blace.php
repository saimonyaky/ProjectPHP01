...
<div id="picture-frame">
			<img src="images/ki5.jpg" data-src="images/ki5.jpg" alt="" class="img-responsive"/>
		</div>
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3>SAMSUNG C34F791WQE 34" VA 2K 100Hz FreeSync</h3>	
				 <div class="pr-single">
				  <p class="reduced "><del>16,490,000</del>12,990,000 VND</p>
				</div>
				<div class="block block-w3">
					<div class="starbox small ghosting"> </div>
				</div>
				<p class="in-pa">
					A high-performance gaming monitor with a 34" VA panel, 2560x1440 resolution, 100Hz refresh rate, and AMD FreeSync support.
				</p>
				<ul>
				  <li>Panel: 34" VA</li>
				  ...
				  <li>Sync technology: AMD FreeSync</li>
				  <li>Inputs: DisplayPort 1.2, HDMI 2.0, USB 3.0</li>
				  <li>Features: 1800R curvature, Quantum Dot technology, Picture-in-Picture</li>
				</ul>
				<p>
				  The SAMSUNG C34F791WQE is a great choice for gamers who want a large, high-resolution display with a fast refresh rate and curved panel. The VA panel provides excellent contrast ratio and deep blacks, while the FreeSync support eliminates screen tearing and stuttering.
				</p>
				<p>
				  The monitor also features a number of gaming-centric features, such as a 1800R curvature, Quantum Dot technology, and Picture-in-Picture.
				</p>
				<p>
				  Here are some additional details about the SAMSUNG C34F791WQE monitor:
				  * The VA panel provides excellent contrast ratio and deep blacks, with a contrast ratio of 3000:1.
				  * The FreeSync support eliminates screen tearing and stuttering, providing smooth gameplay.
				  * The monitor features a number of gaming-centric features, such as a 1800R curvature, Quantum Dot technology, and Picture-in-Picture.
				</p>
				...
				<ul class="social-top">
					...
					<div class="add add-3">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="SAMSUNG C34F791WQE 34" data-summary="summary 1" data-price="12990000" data-quantity="1" data-image="images/ki5.jpg">Add to Cart</button>
										</div>
