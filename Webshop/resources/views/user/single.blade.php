...
<div id="picture-frame">
			...
			<div class="col-md-7 single-top-left ">
				...
				<h3>Intel® Core™ i9-13900KS Processor | 36M Cache, up to 6.00 GHz</h3>
				
					
				 <div class="pr-single">
				  <p class="reduced "><del>25,490,000</del>22,900,000 VND</p>
				</div>
				...
				<ul class="social-top">
					...
					<div class="add add-3">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="Intel Core i9 13900KS" data-summary="summary 1" data-price="22900000" data-quantity="1" data-image="images/si.jpg">Add to Cart</button>
										</div>
