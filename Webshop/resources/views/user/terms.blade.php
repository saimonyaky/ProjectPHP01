         ...
         <b class="line"></b>
            ...
            <div class="ter-wthree">
                ...
                <ol start="1">
                    <li>Lorem Ipsum is simply dummy text of the printing and typesetting industry.it has a more-or-less
                        normal distribution of letters, as opposed Lorem Ipsum has been the industry's standard dummy text
                        ever since the 1500s</li>
            ...
            <div class="ter-wthree">
                ...
                <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical
                    ...
                    Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. </p>
                <p> Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more
                    ...
                    This book is a treatise on the theory of ethics, very popular during the Renaissance</p>
            </div>
            <div class="ter-wthree">
                ...
                <p>first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a
                    ...
                    Lorem Ipsum is therefore always free from repetition, injected humour</p>
            </div>
            <div class="ter-wthree">
                ...
                <p>This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of
            ...
            <div class="ter-wthree">
                ...
                <p> you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum
                    ...
                    generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of
                    model sentence structures</p>
            </div>
        </div>
    </div>
@endsection
