						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">								
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Intel® Core™ i9-13900KS Processor</a>| 36M Cache, up to 6.00 GHz</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6>Intel® Core™ i7-13700KS Processor | 30M Cache, up to 5.00 GHz</h6>							
										</div>
										<div class="mid-2">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal3" class="offer-img">
										<img src="images/i5-13.webp" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6>Intel® Core™ i5-13500H Processor | 318M Cache, up to 4.70 GHz, with IPU</h6>							
										</div>
										<div class="mid-2">
											<p ><label>18,490,000</label><em class="item_price">16,690,000 VND</em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3" data-name="Intel Core i5 13500H" data-summary="summary 3" data-price="16690000" data-quantity="1" data-image="images/i5-13.webp">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal4" class="offer-img">
										<img src="images/cpu-intel-core-i3-13100F.jpg" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6>Intel® Core™ i3-1305U Processor | 10M Cache, up to 4.50 GHz</h6>							
										</div>
										<div class="mid-2">
											<p ><label>14,200,000</label><em class="item_price">9,990,000 VND</em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4" data-name="Intel Core i3 1305" data-summary="summary 4" data-price="9990000" data-quantity="1" data-image="images/cpu-intel-core-i3-13100F.jpg">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
