                                ...
                                @foreach ($dataPc as $key => $val)
                                    <div class="col-md-3 m-wthree">
                                        <div class="col-m">
                                            ...
                                            <div class="mid-1">
                                                <div class="women">
                                                    <h6><a href="single.html">{{ $val['name'] }}</a>| 36M Cache, up to 6.00
                                                        GHz</h6>
                                                </div>
                                                <div class="mid-2">
                                ...
                                @foreach ($dataGear as $key => $val)
                                    <div class="col-md-3 m-wthree">
                                        <div class="col-m">
                                            ...
                                            <div class="mid-1">
                                                <div class="women">
                                                    <h6><a href="single.html">{{ $val['name'] }}</a>| 36M Cache, up to
                                                        6.00 GHz</h6>
                                                </div>
                                                <div class="mid-2">
                                                    <p><label>{{ $val['price'] }}</label><em
                ...
                <div class="col-md1 ">
                    <a href="{{ route('pccomponent') }}">
                        ...
                        <div class="big-sa">
                            <h6>New Collections</h6>
                            <h3>Computer <span>Component</span></h3>
                            <p>There are a variety of computer configurations for you to choose, let's build your most
                                suitable PC setup.</p>
                        </div>
                    </a>
                </div>
