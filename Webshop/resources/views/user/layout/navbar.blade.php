        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav ">
                    ...
                    <li>
                        <a href="{{route('pccomponent')}}" class="hyper"><span>PC Component</span></a>
                    </li>
                    <li>
                        <a href="{{route('gaminggear')}}" class="hyper"><span>Gaming Gear</span></a>
                    </li>
                    <li>
                        <a href="{{route('console')}}" class="hyper"><span>Console</span></a>
                    </li>
